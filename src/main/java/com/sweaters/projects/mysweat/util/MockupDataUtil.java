...
public class MockupDataUtil {
	...
	public static List<ExerciseBatchData> getExerciseBatchDataList() {
		...
		String[][] bodyPartArray = {
				{"BODYPART_CHEST", "BODYPART_CHEST", "BODYPART_CHEST", "BODYPART_CHEST", "BODYPART_ARM"},
				{"BODYPART_BACK", "BODYPART_BACK", "BODYPART_BACK", "BODYPART_BACK", "BODYPART_ARM"},
				{"BODYPART_SHOULDER", "", "", "BODYPART_SHOULDER", "BODYPART_ABS"},
				{"BODYPART_LEG", "BODYPART_LEG", "BODYPART_LEG", "BODYPART_LEG", "BODYPART_ABS"}
		};
		...
		for (int i = 0; i < dateArray.length; i++) {
			...
			List<ExerciseData> exerciseDataList = getExerciseDataList(consoleIdArray[i], exerciseNameArray[i],
					bodyPartArray[i], tagIdArray[i], startDateTimeArray[i], setElapsedTimeArray[i]);
	...
	public static List<ExerciseData> getExerciseDataList(String[] consoleIdArray, String[] exerciseNameArray,
	                                                     String[] bodyPartArray, String tagId, String[] startDateTimeArray, long[] elapsedTimeArray) {
		...
		for (int i = 0; i < consoleIdArray.length; i++) {
			ExerciseData exerciseData = new ExerciseData(consoleIdArray[i], exerciseNameArray[i], bodyPartArray[i],
					tagId, startDateTimeArray[i], elapsedTimeArray[i]);
